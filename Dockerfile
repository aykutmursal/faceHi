...
RUN mkdir -p /comfyui/models/loras && \
    ...
    curl -L --fail --retry 5 --retry-delay 5 \
      -H "Authorization: Bearer ${CIVI_TOKEN}" \
      -o /comfyui/models/loras/hidreamskinench.safetensors\
      "https://civitai.com/api/download/models/1695611?type=Model&format=SafeTensor" && \
    [ -f "/comfyui/models/loras/hidreamskinench.safetensors" ] && \
    echo "Successfully downloaded hidreamskinench.safetensors"
